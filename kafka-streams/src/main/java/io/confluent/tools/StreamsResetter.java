 ...
 * <li>deleting local state store directory for this application</li>
 * </ol>
 * <p>
 ...
 * <p>
 * If you run multiple application instances, you need to run this tool on each application host (to clean local state store directory for all application instances).
 * <p>
    ...
    private void resetInputAndInternalTopicOffsets() {
        ...
        for (final String inTopic : inputTopics) {
            if (!this.allTopics.contains(inTopic)) {
                System.out.println("Topic " + inTopic + " not found. Skipping.");
            }
        }
